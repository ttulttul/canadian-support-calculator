...
- Spousal support is a with-child shared-custody SSAG-style range estimate that produces low, mid, and high amounts using a payroll-aware annual tax model with federal and provincial brackets, basic credits, CPP, EI, and a user-selected tax year.
